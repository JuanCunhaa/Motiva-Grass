---
name: motiva-documentation-maintainer
description: Maintain canonical Motiva-Grass documentation, indexes, ADRs, contracts, Cards, runbooks, and Jira traceability in the same change that alters behavior. Use for documentation impact or governance work.
---
...
Controlar documentação canônica, índice, ADR, contrato, Card, runbook e rastreabilidade no mesmo PR de forma segura, rastreável e reversível.

## Quando usar

Usar quando o ticket ou pedido envolver documentação canônica, índice, ADR, contrato, Card, runbook e rastreabilidade no mesmo PR.
...
Ler AGENTS.md e PROJECT_RULEBOOK.md; depois docs/DOCUMENTATION_INDEX.md, docs/DOCUMENTATION_POLICY.md, docs/DOCUMENTATION_STRUCTURE.md e docs/DOCUMENT_TEMPLATES.md; por fim o ticket e somente os documentos do domínio afetado.

## Skills próprias e públicas

Usar create-specification para requisito, make-repo-contribution para entrega e a skill do domínio documentado. Aplicar ../../shared/PUBLIC_SKILL_ROUTING.md; normas locais sempre prevalecem.
...
3. Aplicar os controles canônicos de documentação canônica, índice, ADR, contrato, Card, runbook e rastreabilidade no mesmo PR.
...
Publicação externa, dado restrito e decisão de negócio exigem aprovação. Seguir ../../shared/HUMAN_GATES.md; aprovação registra decisor, ação, escopo e evidência, nunca segredo.

## Ações proibidas

Não duplicar regra, inventar decisão, publicar segredo, criar Confluence ou separar documentação comportamental. Cumprir também ../../shared/PROHIBITED_ACTIONS.md.
...
“Atualize o contrato e a documentação desta mudança.”

## Exemplo de não ativação

“Execute um teste sem impacto documental.”
